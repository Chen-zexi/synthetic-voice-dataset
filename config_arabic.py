...
preprocessing_map_path = os.path.join(base_dir, "saudi_arabia_placeholder_map.json")
...
multi_turn_translated_output_path = os.path.join(base_dir, "scam_conversation_arabic.json")
multi_turn_from_code = translation_to_code
multi_turn_to_code = "ar"

# legit-call
legit_call_output_path = os.path.join(base_dir, "legit_conversation_arabic.json")
num_legit_conversation = 25
legit_call_region = "Saudi Arabia"
legit_call_language = "Arabic"
...
# voice generation
VOICE_IDS = {
    "ar": ["u0TsaWvt0v8migutHM3M", # Ghizlane
           "A9ATTqUUQ6GHu0coCz8t", # Hamid
           "R6nda3uM038xEEKi7GFl", # Anas
           "VwC51uc4PUblWEJSPzeo", # Abrar Sabbah
           ],
}
voice_language = multi_turn_to_code
voice_input_file_scam = multi_turn_translated_output_path
voice_output_dir_scam = "scam_audio_conversations_arabic"
voice_input_file_legit = legit_call_output_path
voice_output_dir_legit = "legit_audio_conversations_arabic"
voice_sample_limit = 25
voice_is_scam = True

# post processing
post_processing_scam_json_input = os.path.join(base_dir, "scam_conversation_arabic.json")
post_processing_scam_json_output = os.path.join(base_dir, "scam_conversation_arabic_formatted.json")
post_processing_legit_json_input = os.path.join(base_dir, "legit_conversation_arabic.json")
post_processing_legit_json_output = os.path.join(base_dir, "legit_conversation_arabic_formatted.json")
